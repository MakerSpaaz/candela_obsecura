...
<font color="#66ff00">Chapter House:</font> `INPUT[text(showcase):chapter_house]`    <font color="#66ff00">Circle Name:</font> `INPUT[inlineSelect(option(Needle & Thread), option(Tide & Bone), option(Vassal & The Veil), option(Wyrm),option(Crimson Mirror),option( Silver Screen), showcase):circle]`
