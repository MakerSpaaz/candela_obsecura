...
pronouns: 
district: 
Description: **Malcolm Trills** is "a former soldier accustomed to conflict now keeping a watchful eye over Red Lamp, with a helpful hand for those in need."[[3]](https://criticalrole.fandom.com/wiki/Malcolm_Trills#cite_note-4)
connections: 
Abilities: 
Circle:
---
...
> ![[Malcolm_Trills_-_Lizzart.jpg|ws-med]] 
...
<font color="#92d050">Abilities:</font> `INPUT[text(showcase):abilities]`

<font color="#92d050">Chapter House:</font> `INPUT[text(showcase):chapter_house]`

<font color="#92d050">Circle Name:</font> `INPUT[inlineSelect(option(1, Needle & Thread), option(2, Tide & Bone), option(3, Vassal & The Veil), option(4, Crimson Mirror),option(4, Silver Screen), showcase):circle]`
